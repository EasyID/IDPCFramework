...
namespace Software.Main
{
    public partial class uButton : UserControl
    {
        ...
        private string _content = "";                                                  // 按钮的背景颜色，包括边线颜色
        ...
        private void useTray_Paint(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.DrawString(_content, Font, Brushes.Black, rect_text, centerFormat);
        }
        ...
        private void useTray_MouseEnter(object sender, EventArgs e)
        {
            ...
            g.DrawString(_content, Font, Brushes.Black, rect_text, centerFormat);
            g.Dispose();
        }
